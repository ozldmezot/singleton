...
abstract class Singleton
{
    ...
    public static function __callStatic($name, $arguments)
    {
        ...
        if (!isset(static::$instances[$called_class])) {
            ...
            $attributes = static::resolve(static::$attributes[$called_class]);
            self::$instances[$called_class] = $reflector->newInstanceArgs($attributes);
        }
    ...
    protected static function resolve($attributes)
    {
        foreach ($attributes as $key => $attribute) {
            if ($attribute instanceof Singleton) {
                $attributes[$key] = $attribute::instance();
            }
        }
